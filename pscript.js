...
document.body.style.backgroundImage = "url('../../wallpapercave.com/wp/wp5493583.jpg')";
}
...
event.preventDefault();
 ...
 function getRandomSupportResponse() {
     const responses = [
       "We understand the technical challenges you're facing. To ensure a swift resolution, please call our technical support at +1-833-211-1001.",
       "Apologies for the technical inconvenience. If you're encountering issues, our dedicated technical support team is ready to assist. Call us at +1-833-211-1001.",
       "Technical hiccups can be frustrating. Connect with our skilled technical support team by calling +1-833-211-1001 for personalized assistance.",
       "We're sorry for any technical disruptions you're experiencing. Call our technical support at +1-833-211-1001, and we'll work together to find a solution.",
       "Your technical concerns matter to us. Reach out to our expert technical support team at +1-833-211-1001 for immediate assistance.",
       "If technical issues are causing inconvenience, don't hesitate to call our technical support at +1-833-211-1001. We're here to provide the help you need.",
       "To ensure your technical challenges are resolved efficiently, contact our technical support team at +1-833-211-1001. We appreciate your understanding.",
       "Sorry for the technical troubles you're encountering. Call +1-833-211-1001 for specialized technical support and a prompt resolution.",
       "We empathize with the frustration that technical issues can bring. For personalized technical assistance, call our support at +1-833-211-1001.",
       "Experiencing technical difficulties? Our technical support team is ready to assist. Call +1-833-211-1001 for expert guidance and support."
     ];
 ...
 function getSupportResponse(suggestion) {
     if (suggestion.includes('access my account')) {
         return "Certainly! To assist with accessing your account, please call our support at +1-833-211-1001.";
     } else if (suggestion.includes('technical assistance')) {
         return "Of course! For technical assistance, call our support team at +1-833-211-1001 for personalized help.";
     } else if (suggestion.includes('install updates on my system')) {
         return "To ensure your system is up to date, please call our support at +1-833-211-1001 for step-by-step guidance.";
     } else {
